...
export const getCustomerByTagId = (data: any) => {
  return http.request<any>("post", `/api/customer/select_by_tag_id_list`, {
    data
  });
};

export const createCustomerRecoed = (data: any) => {
  return http.request<any>("post", `/api/customer/follow/record/create`, {
    data
  });
};
...
export const recordDel = (id: string) => {
  return http.request<any>(
    "post",
    `/api/customer/follow/record/delete/${id}`,
    {}
  );
};
...
export const recordListByCustomer = (data: any) => {
  return http.request<any>(
    "get",
    `/api/customer/follow/record/list_by_customer`,
    { params: data }
  );
};
...
export const recordListByCustomerAndStaff = (data: any) => {
  return http.request<any>(
    "get",
    `/api/customer/follow/record/list_by_customer_and_staff`,
    { params: data }
  );
};

export const recordListByStaff = (data: any) => {
  return http.request<any>("get", `/api/customer/follow/record/list_by_staff`, {
    data
  });
};
...
export const recordUpdate = (data: any) => {
  return http.request<any>(
    "post",
    `/api/customer/follow/record/update/${data.id}`,
    { data }
  );
};
...
export const delVisit = (id: string) => {
  return http.request<any>(
    "post",
    `/api/customer/visit/force_delete/${id}`,
    {}
  );
};
...
export const visitListByCustomer = (data: any) => {
  return http.request<any>(
    "get",
    `/api/customer/visit/list_by_customer/${data.customer_id}`,
    { params: data }
  );
};

export const visitUpdate = (data: any) => {
  return http.request<any>("post", `/api/customer/visit/update/${data.id}`, {
    data
  });
};
...
export const getOperateByCustomerId = (customer_id: string) => {
  return http.request<any>(
    "get",
    `/api/customer/operator/customer/${customer_id}`
  );
};
...
export const getOperateById = (data: any) => {
  return http.request<any>(
    "get",
    `/api/customer/operator/${data.operator_id}/${data.offset}/${data.limit}`
  );
};
...
export const deleteQueryView = (data: any) => {
  return http.request<any>("post", "/api/customer/batch_delete_query_view", {
    data
  });
};
